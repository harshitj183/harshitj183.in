      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-50 hidden lg:block">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <a href="/" className="flex items-center gap-3 px-3 py-2 bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-lg transition-colors">
        ...
        <section id="articles" className="p-6 lg:p-8">
          <div className="max-w-6xl">
            <div className="flex items-center justify-between mb-8">
              ...
              <a href="/blog" className="text-blue-600 hover:text-blue-700 font-medium text-sm">View All Articles →</a>
            </div>
